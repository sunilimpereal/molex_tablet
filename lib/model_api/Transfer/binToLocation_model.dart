...
List<TransferBinToLocation> transferBinToLocationFromJson(String str) =>
    List<TransferBinToLocation>.from(
        json.decode(str).map((x) => TransferBinToLocation.fromJson(x)));

String transferBinToLocationToJson(List<TransferBinToLocation> data) =>
...
ResponseTransferBinToLocation responseTransferBinToLocationFromJson(String str) =>
    ResponseTransferBinToLocation.fromJson(json.decode(str));

String responseTransferBinToLocationToJson(ResponseTransferBinToLocation data) =>
...
class ResponseTransferBinToLocation {
  ...
  factory ResponseTransferBinToLocation.fromJson(Map<String, dynamic> json) =>
      ResponseTransferBinToLocation(
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        bundleTransferToBinTracking: List<BinTransferToLocationTracking>.from(
            json[" Bundle Transfer to Bin Tracking "]
                .map((x) => BinTransferToLocationTracking.fromJson(x))),
      );
...
class BinTransferToLocationTracking {
  ...
  factory BinTransferToLocationTracking.fromJson(Map<String, dynamic> json) =>
      BinTransferToLocationTracking(
        id: json["id"],
...
ErrorTransferBinToLocation errorTransferBinToLocationFromJson(String str) =>
    ErrorTransferBinToLocation.fromJson(json.decode(str));

String errorTransferBinToLocationToJson(ErrorTransferBinToLocation data) =>
    json.encode(data.toJson());
...
class ErrorTransferBinToLocation {
  ...
  factory ErrorTransferBinToLocation.fromJson(Map<String, dynamic> json) =>
      ErrorTransferBinToLocation(
        status: json["status"],
        statusMsg: json["statusMsg"],
        errorCode: json["errorCode"],
