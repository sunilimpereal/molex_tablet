            ...
            children: [
              Padding(
                ...
                child: Container(
                  height: 70,
                  width: 70,
                  decoration: BoxDecoration(color: Colors.red.shade50, borderRadius: BorderRadius.all(Radius.circular(500))),
                  child: Center(
                    child: Text(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                          width: 200,
                          child: Text("${widget.employee.empId}", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w500)),
                        ),
                      ],
                    ),
                  )
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => Location(
                          ...
                          machine: widget.machineDetails == null ? MachineDetails(machineNumber: "Kitting") : widget.machineDetails!,
                          type: widget.type,
