            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text("${widget.employee.employeeName.substring(0, 2).toUpperCase()}", // TODO
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                          width: 170,
                          child: Text("${widget.employee.empId}", style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.w500)),
                        ),
                      ],
                    ),
                  )
